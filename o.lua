...
local K = Library:AddTab("Ken Haki","6026568198")
...
Ri:AddLabel("Rip Indra")
Ri:AddToggle("Auto Press Haki Color", _G.Farm_Ob_Color, function(vu)
	Open_Color_Haki = vu
...
Ri:AddToggle("Auto Rip Indra", _G.AutoDarkDagger, function(value)
...
-- Item Tab
I:AddLabel("Sword")
I:AddToggle("Auto Saber", _G.AutoSaber, function(value)
				_G.Auto_Saber = value
 ...
 spawn(function()
    ...
    I:AddToggle("Auto Dragon Trident", _G.Auto_Dragon_Trident, function(value)
         _G.Auto_Dragon_Trident = value
        StopTween(_G.Auto_Dragon_Trident)
    end)
    
    I:AddToggle("Auto Dragon Trident [HOP]", _G.Auto_Dragon_Trident_Hop, function(value)
...
I:AddLabel("Misc")
I:AddToggle("Auto Haki Rainbow", _G.Auto_Rainbow_Haki, function(value)
